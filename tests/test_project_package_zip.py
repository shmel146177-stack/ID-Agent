...
def test_project_package_zip_preserves_matching_supports_scheme_manifest(
    monkeypatch,
    tmp_path,
):
    import json
...
def test_project_package_zip_preserves_wrong_supports_scheme_incomplete(
    monkeypatch,
    tmp_path,
):
    import json
...
def test_project_package_zip_preserves_matching_grounding_scheme_manifest(
    monkeypatch,
    tmp_path,
):
    import json
