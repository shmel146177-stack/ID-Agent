...
Ветка: `develop`
Текущая контрольная точка: `dbab4c5` - `Normalize knowledge metadata whitespace`
...
## AI knowledge status - 01.09.2026

Текущая стабильная точка:

`dbab4c5` - `Normalize knowledge metadata whitespace`
...
- модели нормативных фрагментов и результатов поиска;
- устранение повторяющихся поисковых терминов;
- ограничение числа результатов поиска;
- формирование контекста с ограничением размера;
- строгая привязка контекста к источникам;
- проверка нумерации блоков источников;
- защита маркеров источников внутри текста;
- передача контекста через AI API и загрузку документов;
- сохранение идентификаторов источников в анализе, сравнении и проверке;
- проверка соответствия источников при чтении результатов;
- запрет многострочных идентификаторов и метаданных;
- нормализация пробелов в метаданных.

Следующий основной этап:

- постоянное хранилище нормативных источников;
- загрузка первых проверенных источников;
- поиск по сохраненной базе знаний.
